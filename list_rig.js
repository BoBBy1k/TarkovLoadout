...
var rig_list = [
  ...
  {name: "SOE", icon: "assets/rig/02-SOE.png", weight: 0.45, slots: 8, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "Wartech", icon: "assets/rig/03-Wartech.png", weight: 1.8, slots: 10, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "Scout Sniper", icon: "assets/rig/04-ScoutSniper.png", weight: 1.7, slots: 12, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "D3CRX", icon: "assets/rig/05-D3CRX.png", weight: .9, slots: 16, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "Triton", icon: "assets/rig/06-Triton.png", weight: 1.3, slots: 16, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "Blackhawk", icon: "assets/rig/07-Blackhawk.gif", weight: 1.35, slots: 16, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "Blackrock", icon: "assets/rig/08-Blackrock.png", weight: 1.8, slots: 20, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "MK2", icon: "assets/rig/09-MK3.png", weight: 1.65, slots: 20, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "Alpha", icon: "assets/rig/10-Alpha.png", weight: 1.7, slots: 20, class: 0, speed: 0, turn: 0, ergo: 0},
  {name: "Belt", icon: "assets/rig/11-Belt.png", weight: 1.7, slots: 25, class: 0, speed: 0, turn: 0, ergo: 0},
]
