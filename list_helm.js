...
var helm_list = [
    ...
    {name: "SEFRA", icon: "assets/helm/07-SFERA.png", class: 3, durability: 100, material: "Steel", ricochet: "medium", speed: -2, turn: -10, ergo: -3, weight: 3.5, slots: 0},
    {name: "Kiver", icon: "assets/helm/08-Kiver-M.png", class: 3, durability: 35, material: "UHMWPE", ricochet: "medium", speed: -3, turn: -5, ergo: -1, weight: 1.2, slots: 0},
    {name: "LZSH", icon: "assets/helm/09-LZSh.png", class: 3, durability: 30, material: "Aramid", ricochet: "low", speed: -1, turn: -7, ergo: -0, weight: .95, slots: 0},
    {name: "Ronin", icon: "assets/helm/10-Ronin.png", class: 3, durability: 60, material: "Aramid", ricochet: "low", speed: -5, turn: -10, ergo: -5, weight: 1.6, slots: 0},
    {name: "ACHHC", icon: "assets/helm/11-ACHHC.gif", class: 4, durability: 30, material: "Combined", ricochet: "high", speed: -2, turn: -7, ergo: -2, weight: 1.5, slots: 0},
    {name: "TC-2001", icon: "assets/helm/12-TC2001.png", class: 4, durability: 25, material: "Combined", ricochet: "high", speed: -2, turn: -8, ergo: -2, weight: 1.4, slots: 0},
    {name: "TC-2002", icon: "assets/helm/13-TC2002.png", class: 4, durability: 27, material: "Combined", ricochet: "high", speed: -2, turn: -8, ergo: -2, weight: 1.45, slots: 0},
    {name: "ULACH", icon: "assets/helm/14-ULACH.gif", class: 4, durability: 38, material: "UHMWPE", ricochet: "high", speed: -2, turn: -10, ergo: -4, weight: 1.9, slots: 0},
    {name: "ZSH", icon: "assets/helm/15-ZSH.gif", class: 4, durability: 30, material: "Combined", ricochet: "medium", speed: -3, turn: -8, ergo: -2, weight: 3.7, slots: 0},
    {name: "LSHZ-2DTM", icon: "assets/helm/16-LZHZ-2D.png", class: 4, durability: 55, material: "Combined", ricochet: "high", speed: -3, turn: -15, ergo: -10, weight: 3.4, slots: 0},
    {name: "Maska", icon: "assets/helm/17-Maska.gif", class: 4, durability: 60, material: "Steel", ricochet: "medium", speed: -3, turn: -6, ergo: -7, weight: 2.6, slots: 0},
    {name: "Fast MT", icon: "assets/helm/18-FASTMT.gif", class: 4, durability: 40, material: "Combined", ricochet: "high", speed: -1, turn: -7, ergo: 0, weight: 0.9, slots: 0},
    {name: "Airframe", icon: "assets/helm/19-Airframe.png", class: 4, durability: 40, material: "Combined", ricochet: "high", speed: 0, turn: -3, ergo: -3, weight: .88, slots: 0},
    {name: "Altyn", icon: "assets/helm/20-Altyn.png", class: 5, durability: 45, material: "Steel", ricochet: "high", speed: -7, turn: -17, ergo: -6, weight: 4.0, slots: 0},
    {name: "Vulkan", icon: "assets/helm/21-Vulkan.png", class: 6, durability: 55, material: "Combined", ricochet: "high", speed: -7, turn: -33, ergo: -20, weight: 4.5, slots: 0},
];
